...
<body>
    <header>
        <div class="top-box">
            ...
            <div class="cart" >
                <a href="your_small_logo_page.html">
        ...
        <div class="search-containers">
            ...
            <div class="nav-links">
                ...
                <a href="#">Offers</a>
                <a href="#">Help</a>
                <a href="vendorlogin.html">VSignup</a>
                <a href="userregister.php">USignup</a>
                <a href="login.php">VLogin</a>
                <a href="ulogin.php">ULogin</a>
            </div>
        </nav>
    </header>
...
<div class="footer">
    <footer>
        <p> &copy; 2024 HyperGro delivery services.all rights reserved </p> 
    </footer>
